...
class ModelPlain(ModelBase):
    ...
    def feed_data(self, data, need_H=True):
        ...
        if self.our_data:
            self.scale = data['scale'].to(self.device)
            self.resolution = data['resolution'].to(self.device)
        if need_H:
    ...
    def netG_forward(self):
        if self.our_data:
            self.E = self.netG(self.L,self.scale,self.resolution)
        else:
    ...
    def optimize_parameters(self, current_step):
        ...
        self.netG_forward()
        # print (self.E.shape,self.H.shape)
