...
class SCUNet(nn.Module):
    ...
    def __init__(self, in_nc=3, config=[2,2,2,2,2,2,2], dim=128, drop_path_rate=0.0, input_resolution=256):
        ...
        self.upsample = Upsample(4, dim)
        self.conv_last = nn.Conv2d(dim, in_nc, 3, 1, 1)
    def forward(self, x0):
