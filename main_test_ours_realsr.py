...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/mnt/bd/liujikun63/ours/superresolution/ours_sr_realworld_x4_psnr/models/75000_G.pth')
    parser.add_argument('--folder_lq', type=str, default='/mnt/bd/liujikun63/data/DIV2K/DIV2K_test_LR_bicubic/X8_crop', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/mnt/bd/liujikun63/data/DIV2K/DIV2K_test_LR_bicubic/X2_crop', help='input ground-truth test image folder')
...
def define_model(args):
    ...
    if args.task == 'classical_sr':
        model = net(upscale=args.scale, in_chans=1027, img_size=args.training_patch_size, window_size=8,
    ...
    # 003 real-world image sr
        ...
        if not args.large_model:
            ...
            model = net(upscale=4, in_chans=1027, img_size=64, window_size=8,
                        img_range=1., depths=[6, 6, 6, 6, 6, 6], embed_dim=180, num_heads=[6, 6, 6, 6, 6, 6],
                        mlp_ratio=2, upsampler='nearest+conv', resi_connection='1conv')
        else:
