...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/mnt/bd/liujikun63/ours/superresolution/swinir_sr_classical_x4/models/80000_G.pth')
    parser.add_argument('--folder_lq', type=str, default='/mnt/bn/liuwei/data/Classical/Set5/LRbicx', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/mnt/bn/liuwei/data/Classical/Set5/original', help='input ground-truth test image folder')
